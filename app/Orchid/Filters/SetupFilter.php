...
class SetupFilter extends Filter
{
  ...
  public function run(Builder $builder): Builder
  {
    ...
    if (isset($input['code_key']) && $value = htmlspecialchars((string)$input['code_key'], ENT_QUOTES)) {
      $builder->where('code_key', 'LIKE', '%' . $value . '%');
    }

    if (isset($input['value']) && $value = htmlspecialchars((string)$input['value'], ENT_QUOTES)) {
